...
var Kalendaryo = function (_Component) {
  ...
  function Kalendaryo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Kalendaryo.__proto__ || Object.getPrototypeOf(Kalendaryo)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.format = function (arg, dateFormat) {
      if (_this.props.locale) return (0, _dateFns.format)(arg, dateFormat, { locale: _this.props.locale });
      ...
      if ((0, _dateFns.isDate)(arg) && dateFormat === undefined) {
        return _this.format(arg, _this.props.defaultFormat);
      }

      if (typeof arg === 'string' && dateFormat === undefined) {
        return _this.format(_this.state.date, arg);
      }

      if ((0, _dateFns.isDate)(arg) && typeof dateFormat === 'string') {
        return _this.format(arg, dateFormat);
      }
      ...
      return (0, _dateFns.eachDayOfInterval)({ start: (0, _dateFns.startOfMonth)(date), end: (0, _dateFns.endOfMonth)(date) }).map(createDayObject);
      ...
      var getWeeks = function getWeeks(startDay, endDay) {
        ...
        var week = (0, _dateFns.eachDayOfInterval)({ start: startDay, end: endDay }).map(createDayObject);
      ...
      var dayLabelFormat = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'EEE';
      ...
      return (0, _dateFns.eachDayOfInterval)({ start: firstDayOfFirstWeek, end: lastDayOfFirstWeek }).map(function (d) {
        return _this.format(d, dayLabelFormat);
      });
